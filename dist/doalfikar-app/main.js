...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.handleAnimationLineGrowth = function () {
        this.dasharray = 4550;
        this.growth = (this.test.nativeElement.offsetHeight / this.wholepage.nativeElement.offsetHeight) + 1 + (this.test.nativeElement.offsetHeight / this.wholepage.nativeElement.offsetHeight) + ((this.test.nativeElement.offsetHeight / this.wholepage.nativeElement.offsetHeight) / 2);
        this.percentage = ((pageYOffset * this.growth) / this.wholepage.nativeElement.offsetHeight);
    ...
    HomeComponent.prototype.handleScrolling = function () {
        ...
        if ((window.innerHeight + window.scrollY) < (this.wholepage.nativeElement.offsetHeight / 4) && this.containsClass(this.bookContainerAnimation, 'animate') && this.containsClass(this.bookForegroundAnimation, 'animate') && this.containsClass(this.bookBackgroundAnimation, 'animate')) {
            this.reverseBookIcon();
            this.reverseAboutMeText();
        }
        if ((window.innerHeight + window.scrollY) >= (this.wholepage.nativeElement.offsetHeight / 4)) {
            this.animateBookIcon();
            this.animateAboutMeText();
        }
        if ((window.innerHeight + window.scrollY) < (this.wholepage.nativeElement.offsetHeight / 2) && this.containsClass(this.curlybracketIconContainerAnimation, 'animate')) {
            this.reverseCurlybracketIcon();
            this.reverseEducationText();
        }
        if ((window.innerHeight + window.scrollY) >= (this.wholepage.nativeElement.offsetHeight / 2)) {
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["ViewChild"])('wholepage'),
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], HomeComponent.prototype, "wholepage", void 0);
    __decorate([
    ...
    __decorate([
        ...
        __metadata("design:type", _angular_core__WEBPACK_IMPORTED_MODULE_0__["ElementRef"])
    ], HomeComponent.prototype, "test", void 0);
    __decorate([
