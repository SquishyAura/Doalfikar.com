...
var HomeComponent = /** @class */ (function () {
    ...
    HomeComponent.prototype.ngOnInit = function () {
        this.dasharray = 1000;
        this.percentage = ((pageYOffset * 5.2) / this.page.nativeElement.offsetHeight);
    ...
    HomeComponent.prototype.handleScrolling = function () {
        ...
        if (pageYOffset < 521 && this.containsClass(this.bookContainerAnimation, 'animate') && this.containsClass(this.bookForegroundAnimation, 'animate') && this.containsClass(this.bookBackgroundAnimation, 'animate')) {
        ...
        if (pageYOffset < 1521 && this.containsClass(this.curlybracketIconContainerAnimation, 'animate')) {
        ...
        if (pageYOffset < 2521 && this.containsClass(this.bagIconContainerAnimation, 'animate')) {
            this.reverseBagIcon();
...
module.exports = __webpack_require__(/*! C:\Users\Dilf\Desktop\Doalfikar.com\doalfikar-app\src\main.ts */"./src/main.ts");
